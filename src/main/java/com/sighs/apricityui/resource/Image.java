...
public final class Image {
    ...
    public interface ITexture {
        ...
        default int hotspotX() {
            return 0;
        }

        default int hotspotY() {
            return 0;
        }
    ...
    public record StaticTexture(Identifier identifier, int width, int height, int hotspotX, int hotspotY) implements ITexture {
