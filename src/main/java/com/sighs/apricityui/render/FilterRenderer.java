...
//        }
        ...
        bufferbuilder.addVertex(x0, y1, 0).setUv(u0, v1);
        bufferbuilder.addVertex(x1, y1, 0).setUv(u1, v1);
        bufferbuilder.addVertex(x1, y0, 0).setUv(u1, v0);
        bufferbuilder.addVertex(x0, y0, 0).setUv(u0, v0);
