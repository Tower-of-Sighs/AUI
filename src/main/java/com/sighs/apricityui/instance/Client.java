...
public class Client {
    ...
    public static void icon(TickEvent.ClientTickEvent event) {
        if (Minecraft.getInstance().screen instanceof TitleScreen) {
            if (Document.get("apricityui/icon.html").isEmpty()) {
                Document.create("apricityui/icon.html");
            }
        } else {
            Document.remove("apricityui/icon.html");
        }
    }
...
//            com.sighs.apricityui.dev.BackdropFilterTestRunner.onRenderGuiPost();
    ...
    @SubscribeEvent
    public static void scroll(ScreenEvent.MouseScrollEvent.Pre event) {
