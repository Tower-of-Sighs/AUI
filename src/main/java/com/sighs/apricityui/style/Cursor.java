...
public class Cursor {
    ...
    public static void drawPseudoCursor(MatrixStack stack) {
        if (stack == null || pseudoCursorSpec == null) return;
        ...
        ImageDrawer.draw(stack, texture.getLocation(), drawX, drawY, width, height, false);
    }
    ...
    @AllArgsConstructor
    private static class CursorUrlSpec {
        private String path;
