...
public class Sprite extends Div {
    ...
    private static final Set<String> MANAGED_STYLE_KEYS = new HashSet<>(Arrays.asList(
    ...
    private static final Set<String> SPRITE_ATTRS = new HashSet<>(Arrays.asList(
    ...
    private static SpriteSpec.Direction parseDirection(String raw) {
        ...
        switch (raw.trim().toLowerCase(Locale.ROOT)) {
            case "left":
                return SpriteSpec.Direction.LEFT;
            case "up":
                return SpriteSpec.Direction.UP;
            case "down":
                return SpriteSpec.Direction.DOWN;
            default:
    ...
    private static SpriteSpec.FitMode parseFitMode(String raw) {
        ...
        switch (raw.trim().toLowerCase(Locale.ROOT)) {
            case "contain":
                return SpriteSpec.FitMode.CONTAIN;
            case "cover":
                return SpriteSpec.FitMode.COVER;
            case "stretch":
                return SpriteSpec.FitMode.STRETCH;
            default:
