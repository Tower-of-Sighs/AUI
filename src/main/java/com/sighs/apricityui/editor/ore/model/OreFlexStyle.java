...
public final class OreFlexStyle {
    ...
    public void setDirection(String value) {
        direction = value == null || value.isBlank() ? "row" : value;
    }

    public void setWrap(String value) {
        wrap = value == null || value.isBlank() ? "nowrap" : value;
    }

    public void setJustifyContent(String value) {
        justifyContent = value == null || value.isBlank() ? "flex-start" : value;
    }

    public void setAlignItems(String value) {
        alignItems = value == null || value.isBlank() ? "stretch" : value;
    }

    public void setAlignContent(String value) {
        alignContent = value == null || value.isBlank() ? "stretch" : value;
    }

    public void setGap(String value) {
        gap = value == null || value.isBlank() ? "0px" : value;
    }

    public void setRowGap(String value) {
        rowGap = value == null || value.isBlank() ? "0px" : value;
    }

    public void setColumnGap(String value) {
        columnGap = value == null || value.isBlank() ? "0px" : value;
    }
}
