...
public final class OreDocumentMetadata {
    ...
    public Map<String, String> htmlAttributes() {
        return Collections.unmodifiableMap(new LinkedHashMap<>(htmlAttributes));
    }

    public Map<String, String> bodyAttributes() {
        return Collections.unmodifiableMap(new LinkedHashMap<>(bodyAttributes));
    }
