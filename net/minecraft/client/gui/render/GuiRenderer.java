...
public class GuiRenderer implements AutoCloseable {
    ...
    public GuiRenderer(
        ...
        this.pictureInPictureRendererPools = net.neoforged.neoforge.client.gui.PictureInPictureRendererPool.createPools(bufferSource, pipRendererFactories);
    }
    ...
    private void executeDraw(GuiRenderer.Draw draw, RenderPass renderPass, GpuBuffer indexBuffer, VertexFormat.IndexType indexType) {
        ...
        // Neo: support non-quad vertex format modes
        VertexFormat.Mode formatMode = pipeline.getVertexFormatMode();
        if (formatMode != VertexFormat.Mode.QUADS) {
            RenderSystem.AutoStorageIndexBuffer autoStorageIndexBuffer = RenderSystem.getSequentialBuffer(formatMode);
