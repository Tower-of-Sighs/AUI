...
public class ApricityContainerScreen extends AbstractContainerScreen<ApricityContainerMenu> implements AuiLinkedScreen {
    ...
    private void drawMenuSlotItems(GuiGraphics guiGraphics) {
        ...
        com.sighs.apricityui.mixin.accessor.AbstractContainerScreenAccessor access =
                (com.sighs.apricityui.mixin.accessor.AbstractContainerScreenAccessor) (Object) this;
        net.minecraft.world.inventory.Slot clicked = access.aui$getClickedSlot();
        ItemStack draggingItem = access.aui$getDraggingItem();
        boolean splitting = access.aui$isSplittingStack();
        Set<net.minecraft.world.inventory.Slot> quickCraftSlots = access.aui$getQuickCraftSlots();
        boolean quickCrafting = access.aui$isQuickCrafting();
        int quickCraftingType = access.aui$getQuickCraftingType();
