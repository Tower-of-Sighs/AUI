...
public final class ApricityUIClientCommands {
    ...
    public static void register(CommandDispatcher<FabricClientCommandSource> dispatcher) {
        dispatcher.register(ClientCommandManager.literal("aui")
                .then(ClientCommandManager.literal("worldwindow")
                        .executes(context -> spawnTestWindow(context.getSource()))));
    }

    private static int spawnTestWindow(FabricClientCommandSource source) {
        Minecraft minecraft = Minecraft.getInstance();
        if (minecraft == null || minecraft.level == null || minecraft.player == null) {
            source.sendError(Component.literal("AUI worldwindow requires an active client world."));
            return 0;
        }
        ...
        source.sendFeedback(Component.literal("Spawned AUI test worldwindow."));
        return 1;
    }
