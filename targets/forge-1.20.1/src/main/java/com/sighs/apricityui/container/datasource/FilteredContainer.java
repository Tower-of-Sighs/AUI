...
final class FilteredContainer implements Container {
    ...
    private FilteredContainer(Container delegate, Supplier<FilterUtil> filterSupplier) {
    ...
    static Container of(Container container, FilterUtil filter) {
        return of(container, () -> filter);
    }

    static Container of(Container container, Supplier<FilterUtil> filterSupplier) {
        return filterSupplier == null ? container : new FilteredContainer(container, filterSupplier);
    }
    ...
    public void setItem(int slot, ItemStack stack) {
        if (stack == null || stack.isEmpty() || (delegate.canPlaceItem(slot, stack) && accepts(stack))) {
    ...
    public boolean canPlaceItem(int slot, ItemStack stack) {
        return delegate.canPlaceItem(slot, stack) && accepts(stack);
    }
