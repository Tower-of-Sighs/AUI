...
public class ShaderRegistry {
    public static void register(RegisterShadersEvent event) throws IOException {
        ...
        event.registerShader(new ShaderInstance(event.getResourceProvider(),
                ResourceLocation.fromNamespaceAndPath("apricityui", "filter_blur"), DefaultVertexFormat.POSITION_TEX), (instance) -> {
        ...
        event.registerShader(new ShaderInstance(event.getResourceProvider(),
                ResourceLocation.fromNamespaceAndPath("apricityui", "filter_mask_intersect"), DefaultVertexFormat.POSITION_TEX), (instance) -> {
            filterMaskIntersectShader = instance;
        });
        event.registerShader(new ShaderInstance(event.getResourceProvider(),
                ResourceLocation.fromNamespaceAndPath("apricityui", "filter_mask_subtract"), DefaultVertexFormat.POSITION_TEX), (instance) -> {
            filterMaskSubtractShader = instance;
        });
        event.registerShader(new ShaderInstance(event.getResourceProvider(),
                ResourceLocation.fromNamespaceAndPath("apricityui", "filter_mask_exclude"), DefaultVertexFormat.POSITION_TEX), (instance) -> {
    ...
    public static void init(ResourceManager resourceManager) throws IOException {
        ...
        filterMaskExcludeShader = new ShaderInstance(resourceManager, ResourceLocation.fromNamespaceAndPath("apricityui", "filter_mask_exclude"), DefaultVertexFormat.POSITION_TEX);
    }
