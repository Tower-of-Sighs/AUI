...
public final class ResourceService implements AuiResourceService {
    ...
    public Optional<InputStream> openResource(String path) {
        ...
        Identifier location = parseLocation(path);
    ...
    public Map<String, String> listResourcePaths(String path, String suffix) {
        ...
        try {
            Map<Identifier, Resource> resources = manager.listResources(path,
    ...
    public TextureKey tryParseTextureKey(String src) {
        ...
        return Identifier.tryParse(src) == null ? null : TextureKey.of(src);
    }
    ...
    private static Identifier parseLocation(String value) {
        ...
        if (colon >= 0) return Identifier.tryParse(value);
        return Identifier.fromNamespaceAndPath("apricityui", value);
    }
